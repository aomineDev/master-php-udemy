	...
	$sql = "SELECT e.*, DATE_FORMAT(e.fecha, '%d-%m-%Y') AS 'fecha_mod', c.nombre_categoria AS 'nombre' FROM entradas e INNER JOIN categorias c ON e.idcategorias = c.idcategorias ORDER BY  e.fecha DESC LIMIT $limit,$nELementsPage";	
