...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6 login-imgBox d-none d-md-block">
            <img src="{{ asset('img/login/cel-phone.png') }}" class=" login-img" alt="login">
        </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0 justify-content-center">
                            ...
                            <div class="col-12">
                                <a class="text-primary" href="{{ route('register') }}">¿No tienes cuenta? ¡Registrate!</a>
                            </div>
                        @endif
                    </div>
                    </form>
