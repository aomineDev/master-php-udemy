...
class ImageController extends Controller {
    ...
    public function save(Request $request){
        ...
        if($image_path){
            ...
            // TinyCompresor
            $filepath = 'https://www.nibbleframe.club/aomine/laravel-instagram/storage/app/images/' . $image_path_name;
            \Tinify\setKey("pnAXHzekn7rZuJTVzFQDqrZuDrTLwez8");
            $source = \Tinify\fromFile($filepath);
            $source->toFile("../laravel-instagram/storage/app/images/".$image_path_name);
